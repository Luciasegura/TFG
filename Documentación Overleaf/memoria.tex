...
\begin{abstract}
Modelado epidemiológico, modelos compartimentales, SI, SIS, SIR, SEIR, vacunación, simulación, MATLAB, Simulink, controlador PID, enfermedades infecciosas, App Designer, visualización interactiva, epidemias, control de brotes, SIDA/VIH, gonorrea, sarampión, COVID-19\ldots
\end{abstract}
...
\begin{abstract}
Epidemiological modeling, compartmental models, SI, SIS, SIR, SEIR, vaccination, simulation, MATLAB, Simulink, PID controller, infectious diseases, App Designer, interactive visualization, epidemics, outbreak control, HIV/AIDS, gonorrhea, measles, COVID-19
\end{abstract}
